...
lbxHtml.Items.Add('<title>Cotización de Items</title>');
lbxHtml.Items.Add('</head>');
lbxHtml.Items.Add('<body align = "center">');
lbxHtml.Items.Add('<table border = "0" width = "550">');

lbxHtml.Items.Add('<tr><td width = "550"> '+'Panamá, ' + formatdatetime('ddd dd mmmmmmmmm yyyy',now()) + '. </td></tr>');
lbxHtml.Items.Add('<tr><td> <br><br> <p> Estimado(a) ' + edNombre.Text +' <br><br>');
//lbxHtml.Items.Add('<HR width=100% align="left">');
lbxHtml.Items.Add('Seguido encontrará la información sobre la cotización No.: ' + edQoute.text + ' <br><br>');
...
//       BuscaMes(m);
//       lbxHtml.Items.Add('<table border = "0" width = "550">');
//       lbxHtml.Items.Add('<tr><td width = "550"> '+'Panamá, '+IntToStr(d)+' de '+NomMes+' de '+IntToStr(a)+'. </td></tr>');
//       lbxHtml.Items.Add('<tr><td> <br><br> <p> Estimados Señores : <br><br>');
...
//       lbxHtml.Items.Add('<li> Que la suma de todos los cks cuya fecha no haya pasado sea menor que el límite de crédito');
...
//       lbxHtml.Items.Add('se dará cuenta. Por lo anterior en caso de alguna irregularidad; hay que entrar al modulo de');
...
//       lbxHtml.Items.Add('<th width = "125" align = "center" BGCOLOR = "#050021">COMPAÑÍA</th>');
