...
type
  TIWUserSession = class(TIWUserSessionBase)
    ...
    tblBuscarClienteAirboxDB: TADOQuery;
    ...
    tblBuscarClienteidTarifa: TStringField;
    tblLoginUser: TADOQuery;
    tblLoginUserIdUsr: TAutoIncField;
    tblLoginUserUsuario: TStringField;
    tblLoginUserClave: TStringField;
    tblLoginUserNombre: TStringField;
    tblLoginUseridDepartamento: TIntegerField;
    tblLoginUserTipoUsuario: TStringField;
    tblLoginUserEmail: TStringField;
    tblLoginUserTarjetaCredito: TStringField;
    tblLoginUserAutorizados: TStringField;
    tblLoginUserAvanzados: TStringField;
    tblLoginUserActivo: TStringField;
    tblLoginUserBlanco: TStringField;
    tblLoginUserCompras: TStringField;
    tblLoginUserTickets: TStringField;
    tblLoginUserSucursal: TIntegerField;
    tblLoginUserTipoUserTicket: TStringField;
    tblDefaults: TkbmMemTable;
    tblDefaultsFECHA_USO: TDateTimeField;
    tblDefaultsMAX_DESC: TFloatField;
    tblDefaultsAGR_WIP: TStringField;
    tblDefaultsMOD_WIP: TStringField;
    tblDefaultsGARANT: TStringField;
    tblDefaultsINTERN: TStringField;
    tblDefaultsNIV_GAR: TFloatField;
    tblDefaultsPART_WIP: TStringField;
    tblDefaultsSERV_WIP: TStringField;
    tblDefaultsROLL: TStringField;
    tblDefaultsELI_WIP: TStringField;
    tblDefaultsNIVEL: TIntegerField;
    tblDefaultsF_CREA: TDateTimeField;
    tblDefaultsLIMIT_INTERNAS: TFloatField;
    tblDefaultsREGRESAKINTE: TStringField;
    tblDefaultsRECIVEHIKINTE: TStringField;
    tblDefaultsASEGU: TStringField;
    tblDefaultsREPUESTO: TStringField;
    tblDefaultsESTATUS: TStringField;
    tblDefaultsSISTEMA: TStringField;
    tblDefaultsDEPTOINVEQUI: TStringField;
    tblDefaultsDESPACHO: TStringField;
    tblDefaultsRECIVO: TStringField;
    tblDefaultsEQUIPO: TStringField;
    tblDefaultsPROGRAMA: TStringField;
    tblDefaultsCORREDORADUANA: TIntegerField;
    tblDefaultsVERIFIWIP: TStringField;
    tblDefaultsMENU: TStringField;
    tblDefaultsMODULO: TStringField;
    tblDefaultsSUCURSAL: TStringField;
    tblDefaultsBAL_INTERNAS: TStringField;
    tblDefaultsEDITARCLIENTE: TStringField;
    tblDefaultsEDITARCLIENTECXC: TStringField;
    tblDefaultsEDITARPARTE: TStringField;
    tblDefaultsUsuario: TStringField;
    tblDefaultsNombreUsario: TStringField;
    tblDefaultsSucursal2: TStringField;
    tblDefaultsVersion: TStringField;
    tblDefaultsNPersonal: TStringField;
    tblDefaultsDescuentoMaximo: TFloatField;
    tblDefaultsDescuentoV: TFloatField;
    tblDefaultsDescuentoC: TFloatField;
    tblDefaultsAdministrador: TStringField;
  private
